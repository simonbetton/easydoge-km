...
Swift, Kotlin, and Expo expose the parity surface documented in `docs/API.md`, including message signing, P2PKH transaction signing, signing envelopes, and multisig descriptors.
